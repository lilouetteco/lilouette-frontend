...
const translations = {
  en: {
    ...
    home: {
      eyebrow: "Jewelry · Limited collections",
      heroLine1: "One small detail,",
      heroLine2: "you",
      heroLine3: "That changes everything.",
      heroParagraph: "Jewelry carefully chosen to complement your style, every day, in your own way.",
    ...
    cart: {
      ...
      confirmOrderBody: "Are you sure you want to place this order? It's cash payment on delivery — no payment is needed now.",
    ...
    terms: {
      ...
      sections: [
        ...
        {
          title: "7. Exchanges",
          body: "Not the right fit or found an issue? Exchanges are accepted only within 24 hours of receiving your order, as long as it's unworn and still in its original packaging. We only offer exchanges, not refunds.",
        },
        {
  ...
  sq: {
    ...
    home: {
      eyebrow: "Bizhuteri · Koleksione të kufizuara",
      heroLine1: "Një detaj i vogël,",
      heroLine2: "që",
      heroLine3: "Që ndryshon gjithçka.",
      heroParagraph: "Bizhuteri të zgjedhur me kujdes për të plotësuar stilin tënd, çdo ditë, në mënyrën tënde.",
    ...
    cart: {
      ...
      confirmOrderTitle: "Konfirmoni porosinë",
      confirmOrderBody: "Jeni i sigurt që doni ta vendosni këtë porosi? Pagesa bëhet me cash në dorëzim — nuk nevojitet pagesë tani.",
      confirmYes: "Po, vendos porosinë",
      cancel: "Anulo",
